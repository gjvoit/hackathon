...
//		log.info("Logging in anyways");
		try{
			...
			try{
				...
				log.info("ruh roh error");
				// used for unhandled exception where the browser says there's an unhandled popup
...
//	log.info("Successfully logged in in with " + browserName + " and version " + browserVersion);
  }
