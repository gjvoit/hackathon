...
//    	  { new BrowserInfo("internet explorer", "11") }
  ...
  public void TestEngineManagement_95(BrowserInfo browserInfo) throws Exception {
    ...
    try{
	    ...
	    Assert.assertTrue(driver.findElement(By.xpath("html/body/form/table/tbody/tr[5]/td/table/tbody/tr[1]/td[1]")).getText().contains("ELO Number"));
    	Log.info("worked on the first try");
    } catch (Exception e){ 
    	try{
    		Log.info("on try two");
//    		driver.findElement(By.name("tlo_id")).click();
    		driver.findElement(By.name("tlo_id")).sendKeys("TLO 1--Test TLO");
    		Assert.assertTrue(driver.findElement(By.xpath("html/body/form/table/tbody/tr[5]/td/table/tbody/tr[1]/td[1]")).getText().contains("ELO Number"));
        	Log.info("worked on the second try");
    	} catch(Exception f){
    		Log.info("on try three");
    		
    		driver.findElement(By.name("tlo_id")).sendKeys("TLO 1--Test TLO");
    		new Select(driver.findElement(By.name("tlo_id"))).selectByVisibleText("TLO 1--Test TLO");
    	    Assert.assertTrue(driver.findElement(By.xpath("html/body/form/table/tbody/tr[5]/td/table/tbody/tr[1]/td[1]")).getText().contains("ELO Number"));
        	Log.info("worked on the third try");
    	}
    }
    driver.findElement(By.name("title")).clear();
    ...
    try{
    	Log.info("2) on try one");
        driver.findElement(By.name("elo_id")).sendKeys("ELO 1--Test ELO");
	    Assert.assertTrue(driver.findElement(By.xpath("/html/body/form/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr/td[1]")).getText().contains("Please choose Question Type"));
	    Log.info("worked on the first try");
    } catch (Exception e){ 
    	try{
    		Log.info("2) on try two");
    		driver.findElement(By.name("elo_id")).sendKeys("ELO 1--Test ELO");
    	    Assert.assertTrue(driver.findElement(By.xpath("/html/body/form/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr/td[1]")).getText().contains("Please choose Question Type"));
        	Log.info("worked on the second try");
    	} catch(Exception f){
    		Log.info("2) on try third");
    		driver.findElement(By.name("elo_id")).sendKeys("ELO 1--Test ELO");
    	    Assert.assertTrue(driver.findElement(By.xpath("/html/body/form/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr/td[1]")).getText().contains("Please choose Question Type"));
        	Log.info("worked on the third try");
    	}
    ...
    try{
    	...
    	driver.findElement(By.xpath("/html/body/form/table/tbody/tr[6]/td/a"));
    }
    ...
    try{
    	...
    	driver.findElement(By.xpath("/html/body/form/table/tbody/tr[5]/td/a"));
    }
    driver.findElement(By.name("submit3")).click();
